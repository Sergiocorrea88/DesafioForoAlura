package com.desafio.alura.foro.infra.errors;
...
public class TratamientoErrores {
    ...
    public ResponseEntity<String> errorHandlerBusinessValidation(Exception e) {
        return ResponseEntity.badRequest().body(e.getMessage());
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<String> invalidBodyHandler(Exception e) {
        return ResponseEntity.badRequest().body("Algunas partes del cuerpo de la solicitud son inválidas o faltan.");
    }
