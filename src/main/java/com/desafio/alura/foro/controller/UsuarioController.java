...
import com.desafio.alura.foro.domain.usuario.dto.DetallesUsuarioDTO;
import com.desafio.alura.foro.domain.usuario.UsuarioRepository;
import com.desafio.alura.foro.domain.usuario.validations.create.ValidarCrearUsuario;
import com.desafio.alura.foro.domain.usuario.validations.update.ValidarActualizarUsuario;
...
public class UsuarioController {
    ...
    public ResponseEntity<DetallesUsuarioDTO> leerUnUsuario(@PathVariable Long id) {
        ...
        var datosUsuario = new DetallesUsuarioDTO(usuario.getId(),
                usuario.getUsername(),
                usuario.getRole(),
                usuario.getNombre(),
                usuario.getApellido(),
    ...
    @PutMapping("/{username}")
    @Transactional
    @Operation(summary = "Actualiza la contraseña de un usuario, rol, nombre y apellido, correo y estado")
