...
import com.desafio.alura.foro.domain.usuario.dto.AutenticacionUsuarioDTO;
import com.desafio.alura.foro.infra.security.dto.JWTtokenDTO;
...
@Tag(name = "Authentication", description = "Obtiene el token del usuario designado para el acceso")
