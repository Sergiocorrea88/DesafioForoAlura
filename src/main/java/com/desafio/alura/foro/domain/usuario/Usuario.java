...
public class Usuario implements UserDetails { // Implements UserDetails for Spring Security
    ...
    @Override // Implementations for UserDetails methods (assuming password is hashed)
